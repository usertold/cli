      ...
      "bulk-link": {
        ...
        "positionals": [
          ...
          },
          {
            "name": "findingId",
            "required": true,
            "description": "Finding ID to link the Evidence to."
          }
        ],
        "options": [
          "evidence"
  ...
  "findings": {
    ...
    "subcommands": {
      ...
      "create": {
        ...
        "examples": [
          "usertold findings create --help"
        ],
        "operation": "write",
        "auth": "required"
      },
      "create-from-evidence": {
        "summary": "Create a Finding from selected Evidence cards.",
        "positionals": [
          {
            "name": "projectRef",
            "required": false,
        ...
        "examples": [
          "usertold findings create-from-evidence --help"
        ],
        "operation": "write",
        "auth": "required"
      },
      ...
      "push": {
        "summary": "Send a reviewed Finding to product triage.",
        "positionals": [
          {
            "name": "projectRef",
            "required": false,
      ...
      "push-status": {
        ...
        "requiredOptions": [],
        "examples": [
          "usertold findings push-status --help"
        ],
        "operation": "read",
        "auth": "required"
      }
